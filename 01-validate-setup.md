...
1. Clone the project repository from BitBucket to your machine by doing:
    ...
    ```bash
    git clone https://bitbucket.org/tedmyoung/austin-201908-canteen.git
    ```
   ...
   * If you are still having trouble, download and unzip the project instead of using Git:
      ...
      * Go to this URL: 
        ...
        ```
        https://bitbucket.org/tedmyoung/austin-201908-canteen/downloads/
        ```
...
1. Open the `pom.xml` file, either:
   ...
   * From the `File` menu, choose the `Open...` item to open the pom.xml (*don't* use Import) in the `austin-201908-canteen` project directory.
